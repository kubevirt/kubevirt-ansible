...
| version |0.11.0|<ul><li>0.11.0</li><li>0.9.6</li><li>0.8.0</li><li>0.7.0</li><li>0.6.0</li><li>0.5.0</li><li>0.4.1</li><li>0.4.0</li><li>0.3.0</li><li>0.2.0</li><li>0.1.0</li></ul>|KubeVirt release version.|
...
```
ansible-playbook -i inventory  -e version=0.11.0 -e apb_action=provision playbooks/kubevirt.yml
```
